...
<div class="flex items-center gap-3">
    ...
    <input type="checkbox" name="featured" id="featured" value="1"
           ...
           class="w-4 h-4 rounded border-stone-300 accent-amber-500 cursor-pointer flex-shrink-0">
...
{{-- Poem body --}}
<div>
    <label class="block text-sm font-medium text-stone-700 mb-1.5">Poem</label>
